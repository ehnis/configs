...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    networking = {
      ...
      firewall = {
        enable = true;
        allowedTCPPorts = [ 22 80 9993 51820 8080 443 25565 25585 25575 24404 1000 878 567 26900 ];
        allowedUDPPorts = [ 22 80 9993 51820 8080 443 25565 25585 25575 24404 1000 878 567 26900 ];
      };
    };
  };
}
